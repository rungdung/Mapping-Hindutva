<script>
    ...
    $effect(() => {
        // tableData_ = $eventsInHighlight?.features.map((feature) => ({
        //     title: feature.properties.title,
        //     date: feature.properties.date,
        //     involved: feature.properties.involved_groups_openai,
        //     excerpt: feature.properties.excerpt,
        //     link: feature.properties.link, // Added link property
        //     coords: feature.geometry.coordinates,
        // }));
        // select rows which match eventsinhighlight values
        // if (!table.isLoading && $eventsInHighlight?.features.length > 0) {
        //     // table.select(
        //     //     $eventsInHighlight?.features.map((feature) => feature.id),
        //     // );
        //     //loop through the features
        //     table.createSort(table.selected, "desc");
        // }
